...
namespace Animals.Tests
{
    public class AnimalShould
    {
        ...
        public void SetSpeciesMethodShouldSetSpeciesProperty()
        {
            ...
            // string species = _animal.SetSpecies("German Shpeherd"); //this method stores the SetSpecies into species////this example would not be void
        ...
        public void HaveWalkingSpeedSetWithWalkMethod()
        {
            ...
            Assert.Equal(_animal.WalkingSpeed, 0.75);
        }
